 ...
 */
class DEPRECATEDGroovyPathWalker {
    ...
    public static def walk(def item,def path, def scope = null){
        ...
        def normalizedPath = DEPRECATEDGroovyPathWalker.normalizePath(path)
        //splits the normalized path in a liste with every single part of the pat
        List paths = DEPRECATEDGroovyPathWalker.processPath(normalizedPath)
        //walks the path list
